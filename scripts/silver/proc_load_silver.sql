...
Stored Procedure: Load Silver Layers (Bronze -> Silver)

======================================================================================================

Script Purpose:
    This stored procedure perform the ETL (Exteract, Transform, Load) process to
	poplate the 'silver' schema tables from the 'bronze' schema.
Action Performed:
...
BEGIN
	...
	FROM (
		...
		BEGIN CATCH
		      PRINT '=========================================';
			  PRINT 'Loding Silver Layer is Compleated';
